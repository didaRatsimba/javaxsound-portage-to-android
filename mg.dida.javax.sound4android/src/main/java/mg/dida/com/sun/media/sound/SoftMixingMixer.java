...
import mg.dida.javax.sound.share.classes.javax.sound.sampled.Clip;
import mg.dida.javax.sound.share.classes.javax.sound.sampled.Control;
import mg.dida.javax.sound.share.classes.javax.sound.sampled.DataLine;
import mg.dida.javax.sound.share.classes.javax.sound.sampled.Line;
import mg.dida.javax.sound.share.classes.javax.sound.sampled.LineEvent;
import mg.dida.javax.sound.share.classes.javax.sound.sampled.LineListener;
import mg.dida.javax.sound.share.classes.javax.sound.sampled.LineUnavailableException;
import mg.dida.javax.sound.share.classes.javax.sound.sampled.Mixer;
...
import mg.dida.javax.sound.share.classes.javax.sound.sampled.Control.Type;
...
public class SoftMixingMixer implements Mixer {
	...
	private mg.dida.javax.sound.share.classes.javax.sound.sampled.Line.Info[] sourceLineInfo;

	public SoftMixingMixer() {

		sourceLineInfo = new mg.dida.javax.sound.share.classes.javax.sound.sampled.Line.Info[2];
	...
	@Override
	public mg.dida.javax.sound.share.classes.javax.sound.sampled.Mixer.Info getMixerInfo() {
		return info;
	}

	@Override
	public mg.dida.javax.sound.share.classes.javax.sound.sampled.Line.Info[] getSourceLineInfo() {
	...
	@Override
	public mg.dida.javax.sound.share.classes.javax.sound.sampled.Line.Info[] getSourceLineInfo(
			mg.dida.javax.sound.share.classes.javax.sound.sampled.Line.Info info) {
		int i;
		ArrayList<mg.dida.javax.sound.share.classes.javax.sound.sampled.Line.Info> infos = new ArrayList<mg.dida.javax.sound.share.classes.javax.sound.sampled.Line.Info>();
	...
	@Override
	public mg.dida.javax.sound.share.classes.javax.sound.sampled.Line.Info[] getTargetLineInfo() {
		return new mg.dida.javax.sound.share.classes.javax.sound.sampled.Line.Info[0];
	}
	...
	@Override
	public boolean isLineSupported(mg.dida.javax.sound.share.classes.javax.sound.sampled.Line.Info info) {
		if (info != null) {
	...
	@Override
	public mg.dida.javax.sound.share.classes.javax.sound.sampled.Line.Info getLineInfo() {
